...
Write-Host "   ✓ Tags aplicados: ${Tag}, latest" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "✅ Imagen ${Tag} subida exitosamente" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "✅ Imagen latest actualizada exitosamente" -ForegroundColor Green
Write-Host ""
